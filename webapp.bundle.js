(function () {
            ...
            var modes = getCjsExportFromNamespace(list$1);
            ...
            var PADDING = Buffer$d.alloc(16, 0x10);
            ...
            var test = { test_all, getHRMSingle, getHMRMultiple, HMRStop };
            var test_2 = test.getHRMSingle;
            ...
            async function scan() {
              if (!bluetooth) {
                log$1("WebBluetooth nie jest wspierany przez tą przeglądarkę!");
                return;
              }
